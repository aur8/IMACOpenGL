...
int main() {
  ...
  // Chargement des shaders avec plusieurs shader
  ...
  //   GLint uMVPMatrix_location = glGetUniformLocation(shader.id(),
  //   "uMVPMatrix"); GLint uMVMatrix_location =
  //   glGetUniformLocation(shader.id(), "uMVMatrix"); GLint
  //   uNormalMatrix_location =
  //       glGetUniformLocation(shader.id(), "uNormalMatrix");

  //   GLint uTexture1_Location = glGetUniformLocation(shader.id(),
  //   "uTexture1"); GLint uTexture2_Location =
  //   glGetUniformLocation(shader.id(), "uTexture2");
